...
The first uses of heatmaps were applied to 2-dimension data matrices where the individual data values in each cell were encoded with a different color:
