...
If you want to use a different colour scheme, the `col` parameter allows you (actually belongs to the `image` function) modify this. By default the colour scheme is set to `heat.colors(12)`:
